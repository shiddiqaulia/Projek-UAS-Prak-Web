...
$query_user = $koneksi->prepare("SELECT * FROM login WHERE id_login = :id_login");
$query_user->execute([':id_login' => $id_login]);
           ...
           <div class="card-body">
               <form method="post" action="koneksi/proses.php?id=booking">
                    <div class="form-group">
                      <label for="">KTP</label>
                      <input type="text" name="ktp" id="" required class="form-control" placeholder="KTP / NIK Anda" value="<?php echo $user['ktp']; ?>" readonly>
                    </div> 
                    <div class="form-group">
                      <label for="">Nama</label>
                      <input type="text" name="nama" id="" required class="form-control" placeholder="Nama Anda" value="<?php echo $user['nama_pengguna']; ?>" readonly>
                    </div> 
                    <div class="form-group">
                      <label for="">Alamat</label>
                      <input type="text" name="alamat" id="" required class="form-control" placeholder="Alamat" value="<?php echo $user['alamat']; ?>" readonly>
                    </div> 
                    <div class="form-group">
                      <label for="">Telepon</label>
                      <input type="text" name="no_tlp" id="" required class="form-control" placeholder="Telepon" value="<?php echo $user['no_tlp']; ?>" readonly>
                    </div> 
                    <div class="form-group">
