            ...
            <div class="modal-body">
                <form method="post" action="koneksi/proses.php?id=daftar">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ktp" id="" class="form-control" required placeholder="" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
                        <label for="">Alamat</label>
                        <textarea name="alamat" id="" class="form-control" required placeholder="Alamat"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Telepon</label>
                        <input type="text" name="no_tlp" id="" class="form-control" required placeholder="Telepon">
                    </div>
            </div>
